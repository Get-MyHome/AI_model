...
def _empty_draft() -> ExtractionDraft:
    return ExtractionDraft(
        ...
        interim_loan=InterimLoan(
            ...
            settlement_requirement=LoanSettlementRequirement.NOT_STATED,
            settlement_deadline_text=None,
            extension_contingency_disclosed=None,
        ),
        additional_costs=[],
        risk_clauses=[],
        evidence=[],
    ...
    async def _analyze(
        ...
        *,
        ...
        return AnalysisResponse(
            ...
            risk_clauses=normalized.risk_clauses,
